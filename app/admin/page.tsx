...
export default function AdminDashboard() {
    ...
    return (
        <div className="p-10 max-w-7xl mx-auto space-y-12">
            ...
            <header className="relative py-12 px-10 rounded-[40px] overflow-hidden border border-white/5 bg-[#111111]/40 backdrop-blur-md">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-8">
                    <div className="space-y-4">
                        ...
                        >
                            ...
                            <span className="text-[10px] font-bold tracking-[0.4em] uppercase">Control System Online</span>
                        </motion.div>
                        ...
                        >
                            <h1 className="text-4xl md:text-5xl font-extrabold text-white tracking-tight leading-tight">
                                Welcome, <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/40">Administrator</span>
                            </h1>
                            <p className="text-white/40 mt-3 text-lg font-medium max-w-2xl leading-relaxed">
                                You are currently accessing the core management interface of Global Cooperation. All systems are operational.
                            </p>
                        </motion.div>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                    ...
                    <motion.div 
                        ...
                        className="p-8 rounded-3xl border border-white/5 bg-[#161616]/60 backdrop-blur-sm group hover:border-white/10 transition-colors"
                    >
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-8">
                    ...
                    >
                        <Link
                            href="/admin/jobs"
                            className="group relative block overflow-hidden rounded-[32px] border border-white/5 bg-gradient-to-br from-[#161616] to-[#0D0D0D] p-1 shadow-2xl transition-all duration-500 hover:scale-[1.01] hover:border-[#841818]/30"
                        >
                            <div className="relative z-10 p-8 flex items-center gap-8">
                                <div className="w-20 h-20 rounded-[24px] bg-[#1a1a1a] border border-white/5 flex items-center justify-center shrink-0 group-hover:bg-[#841818] group-hover:shadow-[0_0_40px_rgba(132,24,24,0.3)] transition-all duration-500">
                                ...
                                <div className="flex-1 space-y-2">
                                    ...
                                    <p className="text-white/40 leading-relaxed text-sm">
                                        Architect your workforce. Create, publish, and curate high-impact opportunities within the GC network.
                                    </p>
